...
$pageTitle = 'Sobre SCH MEDICOS | Ingeniería hospitalaria desde 1995';
$pageDescription = 'SCH (Servicios para Clínicas y Hospitales) fue fundada en 1995 en Santo Domingo. Conoce nuestra historia, misión, visión, valores, normas, estándares y reconocimientos internacionales.';
...
$milestones = [
    ['1995', 'Fundación en Santo Domingo por el Lic. Fulvio Montisano, con el diseño e instalación de sistemas centrales de gases medicinales.'],
    ...
    ['Hoy', 'Más de 600 proyectos ejecutados y dos sedes operativas: Santo Domingo y Miami.'],
];
...
$standards = [
    ['NFPA 99', 'Código de gases medicinales'],
    ['HTM 2002', 'Estándar hospitalario (UK)'],
    ['ISO 7396-1', 'Redes de gases médicos'],
    ['ISO 9001:2000', 'Gestión de calidad'],
    ['ISO 13485:2003', 'Dispositivos médicos'],
    ['ISO 14001:2005', 'Gestión ambiental'],
    ['ASTM E84', 'Reaccion superficial al fuego'],
    ['CE Mark', 'Conformidad europea'],
    ['SGS', 'Certificación ISO'],
...
<section class="sx-cover" aria-label="Sobre SCH">
    <div class="sx-container sx-cover__grid">
        <div data-reveal>
            ...
            <h1 class="sx-cover__title">Servicios para clínicas y hospitales desde 1995.</h1>
            <p class="sx-cover__lead">SCH fue fundada en Santo Domingo en enero de 1995 para ofrecer soluciones integrales en el equipamiento del área hospitalaria, tanto en el sector público como en el privado.</p>
...
<section class="sx-sec sx-sec--paper" aria-label="Historia">
    <div class="sx-container">
        <div class="sx-sechead" data-reveal>
            ...
            <p class="sx-lead">Lo que comenzo como diseño e instalación de gases medicinales se amplio a ingeniería hospitalaria, consultoria, mantenimiento y equipos especializados.</p>
        </div>
...
<!-- MISSION / VISIÓN -->
<section class="sx-sec sx-sec--graphite" aria-label="Misión y visión">
    <div class="sx-container">
        <div class="sx-sechead" data-reveal>
            <h2 class="sx-h2">Misión y visión.</h2>
        </div>
        <div class="sx-mv">
            <div class="sx-mv__item" data-reveal>
                <div class="sx-mv__label">Misión</div>
            ...
            <div class="sx-mv__item" data-reveal data-reveal-delay="100">
                <div class="sx-mv__label">Visión</div>
                <p class="sx-mv__text">Ser una empresa lider en la comercializacion de equipos médicos y el desarrollo de proyectos hospitalarios, con las mejores prácticas y estándares internacionales, basados en una ejecucion etica y profesional.</p>
            </div>
        </div>
    </div>
</section>
...
<!-- STANDARDS -->
<section class="sx-sec sx-sec--paper" aria-label="Normas y estándares">
    <div class="sx-container">
        <div class="sx-sechead" data-reveal>
            <span class="sx-kicker">Cumplimiento</span>
            <h2 class="sx-h2">Normas y estándares.</h2>
            <p class="sx-lead">Diseñamos, instalamos y certificamos conforme a estándares nacionales e internacionales del sector salud.</p>
        </div>
