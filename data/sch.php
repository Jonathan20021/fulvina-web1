...
$services = [
    [
        ...
        'summary' => 'Conceptualización, diseño, instalación, puesta en marcha y certificación de redes de gases médicos conforme a estándares regulatorios.',
        'image' => 'Gases-5.jpg',
        'items' => ['Salidas de gases', 'Alarmas sectoriales y maestras', 'Cajas de válvulas', 'Manifolds Lifeline', 'Bombas de aire medicinal', 'Compresores de vacío'],
    ],
    [
        'id' => 'equipos',
        'title' => 'Equipamiento médico hospitalario',
        ...
        'items' => ['Quirófanos', 'Cuidados críticos', 'Diagnóstico', 'Ventilación adulto, pediátrica y neonatal', 'Mesas auxiliares', 'Mantenimiento y piezas'],
    ],
    [
        'id' => 'paredes',
        'title' => 'Paredes modulares y protección hospitalaria',
        'summary' => 'Paredes de servicio verticales y horizontales, brazos, columnas, pedestales, revestimientos asépticos y protección para alto tránsito.',
        'image' => 'paredes.jpeg',
        'items' => ['Paredes modulares', 'Brazos de servicio', 'Columnas de servicio', 'Cortinas asépticas', 'Protectores de pared', 'Acabados Acrovyn 4000'],
    ],
];
